...
<body>
    ...
    <div>
        <table>
            <tr>
                <td>名称：</td>
                <td><asp:TextBox ID="tbName" runat="server" MaxLength="20"></asp:TextBox></td>
                <td>电话：</td>
                <td><asp:TextBox ID="txtPhone" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>E-Mail：</td>
                <td><asp:TextBox ID="tbMail" runat="server" MaxLength="20"></asp:TextBox></td>
                <td>地址：</td>
                <td><asp:TextBox ID="tbAddress" runat="server" MaxLength="40"></asp:TextBox></td>
            </tr>
            </table>
    </div>
