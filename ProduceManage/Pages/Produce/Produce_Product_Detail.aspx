<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Produce_Product_Detail.aspx.cs" Inherits="ProduceManage.Pages.Produce.Produce_Product_Detail" %>
...
<body>
    ...
    <div id="form">
        ...
        <tr>
            ...
            <td class ="tdright">
                <asp:Literal ID="lProductName" runat="server"></asp:Literal>
            </td>
        ...
        <tr>
         ...
         <tr>
            <td class ="tdleft">客户单价：</td>
            <td class ="tdright">
                <asp:Literal ID="lCustPrice" runat="server"></asp:Literal>
             </td>
            <td class ="tdleft">工厂单价：</td>
            <td class ="tdright">
                <asp:Literal ID="lFactPrice" runat="server"></asp:Literal>
             </td>
        </tr>
         <tr>
            <td class ="tdleft">客户交期：</td>
            <td class ="tdright">
                <asp:Literal ID="lCustDeliv" runat="server"></asp:Literal>
             </td>
            <td class ="tdleft">工厂交期：</td>
            <td class ="tdright">
                <asp:Literal ID="lFactDeliv" runat="server"></asp:Literal>
             </td>
        </tr>
         <tr>
            <td class ="tdleft">质量员：</td>
            <td class ="tdright">
                <asp:Literal ID="lQualityer" runat="server"></asp:Literal>
             </td>
            <td class ="tdleft">模具费：</td>
            <td class ="tdright">
                <asp:Literal ID="lModelPrice" runat="server"></asp:Literal>
             </td>
        </tr>
         <tr>
            <td class ="tdleft">汇率：</td>
            <td class ="tdright">
                <asp:Literal ID="lExchange" runat="server"></asp:Literal>
             </td>
            <td class ="tdleft">&nbsp;</td>
            <td class ="tdright">
                &nbsp;</td>
    ...
    <div class ="tab" id="delivery"  >
        ...
        <HeaderTemplate ><table cellspacing ="0" cellpadding ="0" border ="0" width ="400" ><tr ><th >日期</th><th >数量</th><th >发货方式</th><th >发票</th><th >HS编码</th><th >操作</th></tr></HeaderTemplate>
        <ItemTemplate ><tr><td><%#this.Bind <IDeliverys >(_=>_.DDate.ToShortDateString ())%></td> 
          <td><%#this.Bind <IDeliverys >(_=>_.Amount)%>  </td>
          <td><%#this.Bind <IDeliverys >(_=>_.TypeName)%></td>
          <td><%#this.Bind <IDeliverys >(_=>_.Invoice)%></td>
          <td><%#this.Bind <IDeliverys >(_=>_.HScode)%></td>
          <td class ="action"><a href ="Delivery_Add.aspx?id=<%#this.Bind <IDeliverys >(_=>_.Id)%>">修改</a> </td></tr>
          </ItemTemplate>
